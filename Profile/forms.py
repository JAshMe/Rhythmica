...
class SignUpFormUser(UserCreationForm):
    ...
    full_name = forms.CharField(label="Full Name", required=True, widget=forms.TextInput(attrs={
                'id': "full-name",
                'class': "form-control",
    ...
    lang = forms.CharField(label="Language", required=True,widget=forms.TextInput(attrs={
                'id': "lang",
                'class': "form-control",
                'placeholder': "Enter your Main Language",
                'required': 'required',
            }))

    class Meta:
        model = User
        fields = ('full_name', 'dob', 'country', 'lang', 'username', 'email', 'password1', 'password2')
        widgets = {
...
class UserLoginForm(AuthenticationForm):
    ...
    password = forms.CharField(max_length=300,widget=forms.PasswordInput(attrs={
            'id': "pass",
            'class': "form-control",
